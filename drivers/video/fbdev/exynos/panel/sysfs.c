...
struct device_attribute panel_attrs[] = {
...
#ifdef CONFIG_SUPPORT_XTALK_MODE
	__PANEL_ATTR_RW(xtalk_mode, 0666),
#endif
#ifdef CONFIG_SUPPORT_MST
	__PANEL_ATTR_RW(mst, 0666),
#endif
#ifdef CONFIG_SUPPORT_POC_FLASH
...
#endif
	__PANEL_ATTR_RW(shadowRGB, 0666),
	__PANEL_ATTR_RW(precision_shadow_fix, 0666),
#ifdef CONFIG_SUPPORT_GRAM_CHECKSUM
	__PANEL_ATTR_RW(gct, 0666),
#endif
#ifdef CONFIG_SUPPORT_GRAYSPOT_TEST
	__PANEL_ATTR_RW(grayspot, 0666),
#endif
	__PANEL_ATTR_RW(irc_mode, 0666),
	__PANEL_ATTR_RW(dia, 0666),
	...
	__PANEL_ATTR_RW(siop_enable, 0666),
	__PANEL_ATTR_RW(temperature, 0666),
#ifdef CONFIG_EXYNOS_LCD_ENG
	__PANEL_ATTR_RW(read_mtp, 0644),
	__PANEL_ATTR_RW(write_mtp, 0644),
	__PANEL_ATTR_RW(gamma_interpolation_test, 0666),
#ifdef CONFIG_SUPPORT_ISC_TUNE_TEST
	__PANEL_ATTR_RW(stm, 0666),
	__PANEL_ATTR_RW(isc, 0666),
#endif
#endif
	__PANEL_ATTR_RW(mcd_mode, 0666),
	__PANEL_ATTR_RW(partial_disp, 0666),
	__PANEL_ATTR_RW(mcd_resistance, 0666),
#ifdef CONFIG_PANEL_AID_DIMMING_DEBUG
...
#endif
	__PANEL_ATTR_RW(alpm, 0666),
	__PANEL_ATTR_RW(lpm_opr, 0666),
	__PANEL_ATTR_RW(fingerprint, 0644),
	__PANEL_ATTR_RW(conn_det, 0666),
#ifdef CONFIG_SUPPORT_HMD
	__PANEL_ATTR_RW(hmt_bright, 0666),
	__PANEL_ATTR_RW(hmt_on, 0666),
#endif
#ifdef CONFIG_DISPLAY_USE_INFO
...
#endif
	__PANEL_ATTR_RW(poc_onoff, 0666),
#ifdef CONFIG_EXTEND_LIVE_CLOCK
	__PANEL_ATTR_RW(self_mask, 0666),
#endif
#ifdef SUPPORT_NORMAL_SELF_MOVE
	__PANEL_ATTR_RW(self_move, 0666),
#endif
#ifdef CONFIG_SUPPORT_ISC_DEFECT
	__PANEL_ATTR_RW(isc_defect, 0666),
#endif
#ifdef CONFIG_SUPPORT_SPI_IF_SEL
	__PANEL_ATTR_RW(spi_if_sel, 0666),
#endif
#ifdef CONFIG_SUPPORT_CCD_TEST
	__PANEL_ATTR_RO(ccd_state, 0444),
#endif
#ifdef CONFIG_SUPPORT_DYNAMIC_HLPM
	__PANEL_ATTR_RW(dynamic_hlpm, 0666),
#endif
#ifdef CONFIG_DYNAMIC_FREQ
	__PANEL_ATTR_RW(dynamic_freq, 0666),
#endif
#ifdef CONFIG_EXYNOS_ADAPTIVE_FREQ
	__PANEL_ATTR_RW(adap_freq, 0666),
#endif
#ifdef CONFIG_SUPPORT_POC_SPI
