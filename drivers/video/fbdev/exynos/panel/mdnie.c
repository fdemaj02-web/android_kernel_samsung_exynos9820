...
struct device_attribute mdnie_dev_attrs[] = {
	__PANEL_ATTR_RW(mode, 0666),
	__PANEL_ATTR_RW(scenario, 0666),
	__PANEL_ATTR_RW(accessibility, 0666),
	__PANEL_ATTR_RW(bypass, 0666),
	__PANEL_ATTR_RW(lux, 0666),
	__PANEL_ATTR_RO(mdnie, 0444),
	__PANEL_ATTR_RW(sensorRGB, 0666),
	__PANEL_ATTR_RW(whiteRGB, 0666),
	__PANEL_ATTR_RW(night_mode, 0666),
	__PANEL_ATTR_RW(color_lens, 0666),
	__PANEL_ATTR_RW(hdr, 0666),
	__PANEL_ATTR_RW(light_notification, 0666),
	__PANEL_ATTR_RW(mdnie_ldu, 0666),
#ifdef CONFIG_SUPPORT_HMD
	__PANEL_ATTR_RW(hmt_color_temperature, 0666),
#endif
#ifdef CONFIG_SUPPORT_AFC
	__PANEL_ATTR_RW(afc, 0666),
#endif
};
